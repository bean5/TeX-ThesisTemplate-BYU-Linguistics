...
%% Last Modified:  Feb 2016 (or later; use git to determine)
...
\byustylesetup{%
    ...
    keywords         = {Some linguistic keywords}
    %
...
% may find that commenting out the next line is necessary.
    ...
    pdftitle    = {Name of your thesis/dissertation.},
...
% Define Title & Author
\title{Name of your thesis/dissertation.}
